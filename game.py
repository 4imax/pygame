...
import sys
from  constans import SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_FILL_COLOR, GAME_CAPTION
...
class Game:
    ...
    def show_game_score(self):
        game_score_text = self.game_font.render(f"Ваш счет: {self.game_score}", True, "white")
        self.screen.blit(game_score_text, (20, 20))

    def show_game_over(self):
        game_over_text = self.game_font.render("Игра окончена", True, 'white')
